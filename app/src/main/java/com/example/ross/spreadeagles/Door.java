...
/**
 * Created by Steve on 9/8/2015.
 */
public class Door extends Breakable {

    public Door(float pX, float pY, ITextureRegion pTextureRegion, VertexBufferObjectManager pVertexBufferObjectManager, SpreadEaglesActivity pParent) {
